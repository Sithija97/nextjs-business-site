        ...
        <div className="max-w-c-1235 mx-auto px-4 md:px-8 xl:px-0">
          <div className="flex items-center gap-8 lg:gap-32.5">
            ...
            >
              ...
              <p>
                We align product, design, and technology so your team can launch
                high-impact customer experiences with less friction.
              </p>
              ...
              <div className="mt-7.5 flex items-center gap-5">
                ...
                <div className="w-3/4">
                  <h3 className="text-metatitle2 mb-0.5 text-black dark:text-white">
                    Reliable architecture and modern tooling
                  </h3>
                  <p>Built for performance, maintainability, and scale.</p>
                </div>
              </div>
              <div className="mt-7.5 flex items-center gap-5">
                <div className="border-stroke dark:border-strokedark dark:bg-blacksection flex h-15 w-15 items-center justify-center rounded-[50%] border">
                ...
                <div className="w-3/4">
                  <h3 className="text-metatitle2 mb-0.5 text-black dark:text-white">
                    Configurable to your business model
                  </h3>
                  <p>Flexible modules that adapt to evolving requirements.</p>
                </div>
              </div>
            </motion.div>
          </div>
        ...
        <div className="max-w-c-1235 mx-auto overflow-hidden px-4 md:px-8 2xl:px-0">
          <div className="flex items-center gap-8 lg:gap-32.5">
            ...
            >
              ...
              <p>
                Connect your core tools, automate key workflows, and reduce
                manual overhead with a streamlined integration layer.
              </p>
              <div>
                <a
                  href="#"
