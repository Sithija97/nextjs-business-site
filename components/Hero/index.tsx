        ...
        <div className="max-w-c-1390 mx-auto px-4 md:px-8 2xl:px-0">
          <div className="flex lg:items-center lg:gap-8 xl:gap-32.5">
            <div className="md:w-1/2">
              ...
              <p>
                We design and deliver scalable digital experiences that help
                teams launch faster, streamline operations, and grow with
                confidence.
              </p>
              ...
              <div className="mt-10">
                ...
                <p className="mt-5 text-black dark:text-white">
                  Talk with our team to plan your next growth milestone.
                </p>
              </div>
            </div>
